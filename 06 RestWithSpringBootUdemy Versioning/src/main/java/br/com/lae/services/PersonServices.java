...
import br.com.lae.converter.custom.PersonConverter;
import br.com.lae.data.model.Person;
import br.com.lae.data.vo.PersonVO;
import br.com.lae.data.vo.v2.PersonVOV2;
...
public class PersonServices {
	...
	public PersonVO update(PersonVO person ) {
		var entity = getFindById(person.getId());
